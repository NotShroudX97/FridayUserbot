...
RUN wget -O opencv.zip https://github.com/opencv/opencv/archive/alpha.zip && unzip opencv.zip && mv -f opencv-master /usr/bin/ && rm opencv.zip
RUN git clone https://github.com/NotShroudX97/HyperFusionX /root/fridaybot
